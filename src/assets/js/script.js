...
(function ($) {
    ...
    /*=====================
         ...
         $('.block-title').on('click', function (e) {
             console.log('Clicked block title: 323')
            e.preventDefault;
            var speed = 300;
    ...
    /*=====================
         ...
         $('.chat-cont-toggle').on('click', function (e) {
             console.log('Chat content toggle: 354')
    ...
    /*=====================
        ...
        // left top main navbar navigation bellow logo
        $(".sidebar-top  a").on('click', function () {
            $(".sidebar-top  a").removeClass("active");
            $(this).addClass("active");
            $('.dynemic-sidebar').removeClass("active");
            console.log('Clicked:',this)
            var active_class = $(this).attr("data_href");
            $('#' + active_class.replace('.html','')).addClass("active");
        });
    ...
    /*=====================
      ...
      $('.mobile-sidebar').on('click', function () {
          console.log('clicked mobile sidebar: 534')
        $('.chitchat-container').toggleClass("mobile-menu");
    });
      $('.chat-main .chat-box').on('click', function () {
          console.log('Clicked chat main chat box: 538')
        $('.chitchat-container').toggleClass("mobile-menu");
    });
    // implemented in angular
    //   $('.group-main .group-box').on('click', function () {
    //       console.log('FROM JQUERY: clicked GROUPMAIN .GROUPBOX')
    //     $('.chitchat-container').toggleClass("mobile-menu");
    // });
      $('.call-log-main .call-box').on('click', function () {
          console.log('Clicked call log main call box: 547')
        $('.chitchat-container').toggleClass("mobile-menu");
    });
      $('.contact-log-main .contact-box').on('click', function () {
          console.log('Clicked contact log main contact box: 551')
        $('.chitchat-container').toggleClass("mobile-menu");
    });

      $('.mobile-back').on('click', function () {
          console.log('Clicked mobile back: 556')
        $('.chitchat-container').toggleClass("mobile-menu");
      ...
      $('.chat-friend-toggle').on('click', function () {
          console.log('Clicked chat friend toggle : 563')
        $('.chat-frind-content').toggle();
    });
    // implemented in angular
    //   $('.gr-chat-friend-toggle').on('click', function () {
    //       console.log('Clicked gr-chat-friend-toggle')
    ...
    /*=====================
           ...
           $(".app-list-ul  a").on('click', function () {
            ...
            // console.log('Set active class to elm id:',active_class)
        });
        // change body to main
           $('.apps-toggle').on('click', function () {
               console.log('Clicked apps toggle : 625')
            if (!$('main').hasClass('sidebar-active main-page menu-active'))
                $('main').toggleClass('sidebar-active main-page');
    ...
    /*=====================
        ...
        //    change body to main
           $('.menu-trigger, .close-profile').on('click', function (e) {
               console.log('Clicked menu trigger close profile: 640')
            $('main').toggleClass('menu-active'); //add class
          ...
          if ($('main').hasClass('menu-active')) {
            $('main').addClass('sidebar-active main-page');
    ...
    /*=====================
           ...
           $('.dropdown').click(function () {
               console.log('Clicked dropdown: 660')
    ...
    /*=====================
        ...
        // add event listener for on change on #setemoj
        $('#setemoj').change(function(e){
            if(!e.target.value){
                $('#send-msg').addClass('disabled').attr("disabled","disabled")
            } else {
                $('#send-msg').removeClass('disabled').removeAttr("disabled")
    ...
    //TODO: implement on angular
    $(".mainnav").on("click", function () {
        console.log('Clicked main nav btn: 825')
    ...
    // body changed to main
    $(".close-app").on("click", function () {
        console.log('Clicked close app: 836')
        $('main').removeClass("sidebar-active");
        $('.app-sidebar').removeClass("active");
    });
    
    $(".close-panel").on("click", function () {
        console.log('Clicked close panel: 842')
    ...
    // body changed to main
    $("main").on("click", ".colors li", function () {
    // console.log('Cliked on color:',this)
        $(this).addClass('active').siblings().removeClass('active');
